        ...
        <form class="flex flex-col gap-9" method="POST">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex gap-5">
                    ...
                    <div class="flex-1">
                        <label for="phonenumber" class="block mb-2 text-sm text-gray-600">Nomor Telepon
                            <span class="text-red-600">*</span></label>
                ...
                <div class="flex gap-5">
                    ...
                    <div class="flex-1">
                        ...
                        <input type="time" name="start_time" id="start_time" autocomplete="given-start_time"
                            class="w-full py-3 bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('start_time') }}" required step="300">
                        @error('start_time')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="flex gap-5">
                    <div class="flex-1">
                        ...
                        <input type="time" name="end_time" id="end_time" autocomplete="given-end_time"
                            class="w-full py-3 bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"
                            value="{{ old('end_time') }}" required step="300">
                        @error('end_time')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="flex flex-col gap-4">
                <h1 class="text-xl font-medium">Keterangan<span class="text-red-600">*</span></h1>
                <div class="flex gap-5">
                    <div class="flex-1">
                        <label for="keterangan" class="block mb-2 text-sm text-gray-600">Keterangan
                            Tambahan</label>
                        <textarea name="keterangan" id="keterangan" rows="4"
                            class="w-full py-3 bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
